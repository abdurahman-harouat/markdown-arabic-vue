...
<template>
    ...
    <!-- Input -->
      <textarea class="input overflow-auto border-none border-l-2 border-solid border-gray-500 bg-gray-100 resize-none outline-none text-lg p-8 box-border h-full w-1/2 scrollbar-thin scrollbar-thumb-rose-700 scrollbar-track-rose-300 overflow-y-scroll" :value="storage" @input="update" name="storage" type="text" dir="auto"></textarea>
